...
// NHMultiIPE represents a Function Hiding Multi-input Inner Product
...
// NewNHMultiIPE configures a new instance of the scheme. See struct
// NHMultiIPEParams for the description of the parameters. It returns
// a new NHMultiIPE instance.
func NewNHMultiIPE(secLevel, numClients, vecLen int, boundX, boundY *big.Int) *NHMultiIPE {
	params := &NHMultiIPEParams{SecLevel: secLevel, NumClients: numClients,
		VecLen: vecLen, BoundX: boundX, BoundY: boundY}
	return &NHMultiIPE{Params: params}
}

// NewNHMultiIPEFromParams takes configuration parameters of an existing
// NHMultiIPE scheme instance, and reconstructs the scheme with the same
// configuration parameters. It returns a new NHMultiIPE instance.
...
func (f NHMultiIPE) GenerateKeys() (*NHMultiIPESecKey, *bn256.GT, error) {
	...
	return &NHMultiIPESecKey{BHat: BHat, BStarHat: BStarHat}, gTMu, nil
}
